...
@section('title', 'Home - Pineus Tilu')
...
<div class="bg-white shadow-lg sticky top-16 z-40 border-b" x-data="{ showFilter: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <form method="GET" action="{{ route('home') }}" class="md:flex items-end space-y-4 md:space-y-0 md:space-x-6" :class="{'hidden': !showFilter}" x-show="true">
            <div class="flex-1">
                ...
                <select name="type" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white">
                    ...
                    <option value="Standard" {{ request('type') == 'Standard' ? 'selected' : '' }}>🏕️ Standard</option>
                    ...
                    <option value="Backpacker" {{ request('type') == 'Backpacker' ? 'selected' : '' }}>🎒 Backpacker</option>
                    <option value="Romance" {{ request('type') == 'Romance' ? 'selected' : '' }}>💖 Romance</option>
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('home') }}" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 transition font-semibold flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div id="camping-spots" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="camping-card group">
            <div class="relative h-64 overflow-hidden">
                <img src="{{ $room->image }}" alt="{{ $room->name }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <span class="text-2xl font-bold text-green-600">Rp {{ number_format($room->price, 0, ',', '.') }}</span>
    ...
    <div class="text-center py-16 bg-white rounded-2xl shadow-lg">
        ...
        <a href="{{ route('home') }}" class="inline-block bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition">
...
<div class="bg-gradient-to-r from-green-600 to-emerald-700 text-white py-16">
    <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
        ...
        <a href="{{ route('home') }}#camping-spots" class="inline-block bg-white text-green-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg text-lg">
            Booking Sekarang 🏕️
        </a>
    </div>
</div>
